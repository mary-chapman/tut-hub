...
ALTER TABLE Difficulties ADD CONSTRAINT Difficulties_fk0 FOREIGN KEY (user_id) REFERENCES Users(id);

ALTER TABLE Difficulties ADD CONSTRAINT Difficulties_fk1 FOREIGN KEY (tutorial_id) REFERENCES Tutorials(id);
